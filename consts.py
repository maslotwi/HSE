...
hero_ids = (
    ...
    'Dhuin', 'Oidana', 'Neia', 'Eikthurn', 'Creyle', 'Spadum', 'Kynr', 'Ergon', 'Kriv', 'Glacius', 'Sial', 'Dalton',
    'Biarma', 'Akka', 'Vehr', 'Allora', 'Haugir'
)

# 00 00 00 00 00 00 00 01 00 00 00 02 00 00 00 00 00 04 00 00 00 00 00 00 00 03 00 00 00 00

campaign_heroes = ('Catherine', 'Roland', 'Gelu', 'Dracon', 'Xeron', 'Haart Lich', 'Mutare', 'Mutare Drake', 'Boragus',
                   'Kilgor', 'Adrienne', 'Bidley', 'Tark', 'Tavin', 'Murdoch', 'Frederick', 'Haugir')
...
# 00 00 00 00 00 00 00 01 00 00 00 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
